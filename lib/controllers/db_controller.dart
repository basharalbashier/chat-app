...
//       'CREATE TABLE info (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, phone TEXT,email TEXT,uuid TEXT,points INTEGER,lastup  TEXT )';
//   initDB() async {
